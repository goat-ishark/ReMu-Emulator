...
module bwstage #(
    ...
    parameter PHV_LEN = 64*8+32*8+16*8+256+100,
    parameter KEY_LEN = 16,
    parameter ACT_LEN = 16,
    // parameter KEY_OFF = 6*3+20,
	parameter C_VLANID_WIDTH = 12,
	parameter   TIME_SCALE_WIDTH = 32
)
(
    input									axis_clk,
    input									aresetn,
    ...
    //control path
    input [C_S_AXIS_TDATA_WIDTH-1:0]			c_s_axis_tdata,
	input [C_S_AXIS_TUSER_WIDTH-1:0]		c_s_axis_tuser,
	input [C_S_AXIS_TKEEP_WIDTH-1:0]		c_s_axis_tkeep,
	input									c_s_axis_tvalid,
	input									c_s_axis_tlast,

    output [C_S_AXIS_TDATA_WIDTH-1:0]		c_m_axis_tdata,
	output [C_S_AXIS_TUSER_WIDTH-1:0]		c_m_axis_tuser,
	output [C_S_AXIS_TKEEP_WIDTH-1:0]		c_m_axis_tkeep,
...
// wire [C_S_AXIS_TDATA_WIDTH-1:0]				c_s_axis_tdata_1;
// wire [((C_S_AXIS_TKEEP_WIDTH))-1:0]		c_s_axis_tkeep_1;
// wire [C_S_AXIS_TUSER_WIDTH-1:0]				c_s_axis_tuser_1;
// wire 										c_s_axis_tvalid_1;
// wire 										c_s_axis_tlast_1;

// reg [C_S_AXIS_TDATA_WIDTH-1:0]				c_s_axis_tdata_1_r;
// reg [((C_S_AXIS_TKEEP_WIDTH))-1:0]			c_s_axis_tkeep_1_r;
// reg [C_S_AXIS_TUSER_WIDTH-1:0]				c_s_axis_tuser_1_r;
// reg 										c_s_axis_tvalid_1_r;
// reg 										c_s_axis_tlast_1_r;

//control path 2 (lkup2action)
// wire [C_S_AXIS_TDATA_WIDTH-1:0]				c_s_axis_tdata_2;
// wire [((C_S_AXIS_TKEEP_WIDTH))-1:0]		c_s_axis_tkeep_2;
// wire [C_S_AXIS_TUSER_WIDTH-1:0]				c_s_axis_tuser_2;
// wire 										c_s_axis_tvalid_2;
// wire 										c_s_axis_tlast_2;

// reg [C_S_AXIS_TDATA_WIDTH-1:0]				c_s_axis_tdata_2_r;
// reg [((C_S_AXIS_TKEEP_WIDTH))-1:0]			c_s_axis_tkeep_2_r;
...
wire [ACT_LEN-1:0]        lookup2action_action;
wire                         lookup2action_action_valid;
wire [PHV_LEN-1:0]           lookup2action_phv;
wire                         action2lookup_ready;

reg [ACT_LEN-1:0]        lookup2action_action_r;
...
wire   [15:0]                 link_id        ;  //use link id for match bandwidth of one link
assign link_id = phv_in[255:240];               // metadata[255:240] is used for link id
assign key2lookup_phv       = phv_in          ;
assign key2lookup_phv_valid = phv_in_valid    ;
 //link_model+dis;
assign key2lookup_key       = link_id		   ;
assign key2lookup_key_valid = phv_in_valid    ;
assign stage_ready_out      = lookup2key_ready;

bw_lookup_engine_top #(
    ...
    .action						(lookup2action_action      ),//VDT+LOSS_STATE
...
bw_action_engine(
    ...
    .phv_in         (lookup2action_phv_r         ),//phv
